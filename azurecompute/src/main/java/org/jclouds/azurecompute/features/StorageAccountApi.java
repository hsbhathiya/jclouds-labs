...
public interface StorageAccountApi {
   ...
   StorageService get(@PathParam("subscriptionId") String subscriptionId, @PathParam("storageAccountName") String storageAccountName);
   ...
   Availability checkAvailable(@PathParam("subscriptionId") String subscriptionId, @PathParam("storageAccountName") String storageAccountName);
   ...
   @ResponseParser(ParseRequestIdHeader.class)
   String delete(@BinderParam(NetworkConfigurationToXML.class) NetworkConfiguration networkConfiguration);
