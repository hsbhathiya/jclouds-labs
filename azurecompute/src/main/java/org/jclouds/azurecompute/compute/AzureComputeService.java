...
public final class AzureComputeService extends BaseComputeService {

  // private final Function<Set<? extends NodeMetadata>, Set<String>> findOrphanedGroups;
   private final GroupNamingConvention.Factory namingConvention;
   private final AzureComputeApi api;
   private final Predicate<String> operationSucceedPredicate;

   @Inject AzureComputeService(ComputeServiceContext context,
        ...
        // Function<Set<? extends NodeMetadata>, Set<String>> findOrphanedGroups,
         ...
         AzureComputeApi api,
         Predicate<String> operationSucceedPredicate) {
     ...
     // this.findOrphanedGroups = findOrphanedGroups;
      ...
      this.api = api;
      this.operationSucceedPredicate = operationSucceedPredicate;
   }

   @Override
   public AzureComputeTemplateOptions templateOptions() {
      return AzureComputeTemplateOptions.class.cast(super.templateOptions());
   }
}
