   ...
   public <R extends HttpRequest> R bindToRequest(R request, Object input) {
      ...
      try {
         ...
         for (RoleParam roleParam : params.roleParams()) {
              ...
              roleBuilder.e("RoleName").t(roleParam.roleName()).up()
            ...
            if (vmImage == null || vmImage.isEmpty()) {
               ...
               if (roleParam.OSVirtualHardDiskParam().OS() == OSImage.Type.WINDOWS) {
                  ...
                  if (domainJoin != null) {
                     ...
                     for (WindowsConfigurationSetParams.Credential credential : winParams.domainJoin().credentials()) {
                        credentialsBuilder.e("Domain").up()
                  ...
                  configBuilder.e("StoredCertificateSettings").up().up(); // Windows ConfigurationSet
               ...
               for (DataVirtualHardDiskParam dataDiskParam : roleParam.dataVirtualHardDiskParams()) {
                  ...
                  dataDiskBuilder.e("DiskName").t(dataDiskParam.diskName()).up()
               ...
               roleBuilder.e("RoleSize").t(roleParam.roleSize().getText()).up().up(); //Role
            } else {
