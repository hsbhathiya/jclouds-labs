...
public abstract class WindowsConfigurationSetParams {
   ...
   public static final class Builder {
      ...
      public Builder fromWindowsConfigurationSetParams(WindowsConfigurationSetParams in) {
         return computerName(in.computerName()).adminPassword(in.adminPassword()).domainJoin(in.domainJoin())
               .adminUserName(in.adminUserName()).storedCertificateSettings(in.storedCertificateSettings());
      }
   }
