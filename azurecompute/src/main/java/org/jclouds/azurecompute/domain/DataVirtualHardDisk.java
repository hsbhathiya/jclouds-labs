...
public abstract class DataVirtualHardDisk {
   ...
   public static DataVirtualHardDisk create(String hostCaching, String diskLabel, String diskName,
         Integer lun, Integer logicalDiskSizeInGB, URI mediaLink, URI sourceMediaLink, String IOType) {
      return new AutoValue_DataVirtualHardDisk(hostCaching, diskLabel, diskName, lun,
            logicalDiskSizeInGB, mediaLink, sourceMediaLink, IOType);
   }
}
