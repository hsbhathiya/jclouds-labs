   ...
   public static final class Builder {
      ...
      public LinuxConfigurationSetParams build() {
         return LinuxConfigurationSetParams
               .create(configurationType, hostName, userName, userPassword, disableSshPasswordAuthentication, ssh);
      }

      public Builder fromLinuxConfigurationSetParams(LinuxConfigurationSetParams in) {
         return hostName(in.hostName()).userName(in.userName()).userPassword(in.userPassword())
               .disableSshPasswordAuthentication(in.disableSshPasswordAuthentication());
      }
   }

   public static LinuxConfigurationSetParams create(String configurationType, String hostName, String userName,
         String userPassword, Boolean disableSshPasswordAuthentication, SSH ssh) {
