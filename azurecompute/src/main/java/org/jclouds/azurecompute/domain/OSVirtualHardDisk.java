...
public abstract class OSVirtualHardDisk {
   ...
   public static OSVirtualHardDisk create(Caching hostCaching, String diskName, URI mediaLink,
         String sourceImageName, OSImage.Type OS, URI remoteSourceImageLink, String IOType) {
      return new AutoValue_OSVirtualHardDisk(hostCaching, diskName, mediaLink, sourceImageName, OS,
