...
@AutoValue
public abstract class DataVirtualHardDiskParam {
   ...
   public static final class Builder {
      ...
      public Builder fromDataVirtualHardDiskParams(DataVirtualHardDiskParam in) {
         return hostCaching(in.hostCaching())
               .diskLabel(in.diskLabel())
               .diskName(in.diskName())
               .LUN(in.LUN())
               .logicalDiskSizeInGB(in.logicalDiskSizeInGB())
   ...
   public static DataVirtualHardDiskParam create(String hostCaching, String diskLabel, String diskName,
         Integer lun, Integer logicalDiskSizeInGB, URI mediaLink, URI sourceMediaLink) {
      return new AutoValue_DataVirtualHardDiskParam(hostCaching, diskLabel, diskName, lun,
            logicalDiskSizeInGB, mediaLink, sourceMediaLink);
   }
}
