...
public abstract class Role {
   ...
   */
   ...
   @Nullable public abstract RoleSizeEnum roleSize();
   ...
   public static Role create(String roleName, String roleType, String VMImageName, URI mediaLocation, RoleSizeEnum roleSize,
