...
public abstract class CloudServiceProperties {
   ...
   public static CloudServiceProperties create(String name,URI url, String location, String affinityGroup, String label,
         String description, Status status, Date created, Date lastModified, Map<String, String> extendedProperties,
         List<Deployment> deployments) {
      return new AutoValue_CloudServiceProperties(name, url, location, affinityGroup, label, description, status, created,
            lastModified, copyOf(extendedProperties), copyOf(deployments));
   }
}
