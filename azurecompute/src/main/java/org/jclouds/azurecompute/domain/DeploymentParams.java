...
public abstract class DeploymentParams {
   ...
   public abstract RoleSizeName size();
   ...
   public static final class Builder {
      private String name;
      private RoleSizeName size = RoleSizeName.SMALL;
      ...
      public Builder size(RoleSizeName size) {
         this.size = size;
         return this;
      }
   ...
   private static DeploymentParams create(String name, RoleSizeName size, String username, String password, String sourceImageName,
