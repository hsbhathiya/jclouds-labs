...
@Test(groups = "unit", testName = "DeploymentToVirtualMachineTest")
public class DeploymentToVirtualMachineTest {
   public void testDeploymentTransform() {
      DeploymentToVirtualMachine deploymentToVirtualMachine = new DeploymentToVirtualMachine();
      Deployment deployment = DeploymentHandlerTest.expected();
      List<VirtualMachine> transformed = deploymentToVirtualMachine.apply(deployment);
