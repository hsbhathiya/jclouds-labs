...
public class CloudServicePropertiesHandlerTest extends BaseHandlerTest {
   ...
   public void test() {
      ...
      CloudServiceProperties result = factory.create(
            new CloudServicePropertiesHandler(dateService, new DeploymentHandler(
   ...
   public static Deployment expected() {
      return Deployment.create( //
            ...
            ImmutableList.of(Deployment.VirtualIP
                  .create("191.233.85.49", true, "node1855162607153993262-b26ContractContract")), //virtualIPs
            ...
            ImmutableList.of(Role.create(
                  ...
                  ImmutableList.of(ConfigurationSet.create(
                        ...
                        ImmutableList.of(
                              InputEndpoint
                                    .create("tcp_22-22", "tcp", 22, 22, "191.233.85.49", false, null, null, null),
                              InputEndpoint
                                    .create("tcp_2375-2375", "tcp", 2375, 2375, "191.233.85.49", false, null, null,
                                          null)
                        ),
                        ImmutableList.of(ConfigurationSet.SubnetName.create("Subnet-1")),
                        null,
                        ImmutableList.<ConfigurationSet.PublicIP>of(), "vnetnsgsg01")),
